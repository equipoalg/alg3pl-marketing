...
<div style="display:flex;height:100%;background:var(--bg);">
    ...
    {{-- ═══════════════════ SIDEBAR (224px) ═══════════════════ --}}
    @include('alg-dashboard.sidebar-a', ['navSections' => $data['navSections']])

    <div style="flex:1;display:flex;flex-direction:column;overflow:auto;min-width:0;">

        {{-- ═══════════════════ TOPBAR ═══════════════════ --}}
        <div style="display:flex;align-items:center;justify-content:space-between;padding:0 28px;height:52px;border-bottom:1px solid var(--border);background:var(--bg);">
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <span style="font-size:12.5px;color:var(--ink-4);">ALG SV</span>
                @include('alg-dashboard.icon', ['name' => 'chevron-right', 'size' => 12, 'stroke' => 'var(--ink-5)'])
                <span style="font-size:12.5px;color:var(--ink-1);font-weight:500;">Panorama global</span>
            </div>
        ...
        <div style="padding:24px 28px 8px;display:flex;flex-direction:column;gap:16px;">
