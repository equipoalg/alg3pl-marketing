...
<div style="display:flex;height:100%;background:var(--surface);">
    ...
    @include('alg-dashboard.sidebar-b')

    <div style="flex:1;display:flex;flex-direction:column;overflow:auto;min-width:0;">

        {{-- ═══════════════════ HERO ═══════════════════ --}}
        <section style="padding:32px 36px 28px;border-bottom:1px solid var(--border);background:var(--surface);">
        ...
        {{-- ═══════════════════ PIPELINE STRIP ═══════════════════ --}}
        <section style="padding:24px 36px;border-bottom:1px solid var(--border);">
        ...
        {{-- ═══════════════════ ACTIVITY + TASKS ═══════════════════ --}}
        <section style="padding:24px 36px 40px;">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:32px;">
                {{-- Activity --}}
                <div>
