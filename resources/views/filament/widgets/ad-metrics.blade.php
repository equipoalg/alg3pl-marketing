...
<div style="padding:22px 24px 20px;">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;padding-bottom:16px;border-bottom:1px solid #E7E5E4;margin-bottom:20px;">
        ...
        <button
            ...
            style="display:inline-flex;align-items:center;gap:6px;background:#0C0A09;color:#FAFAF9;border:none;border-radius:0;padding:7px 12px;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;font-weight:500;cursor:pointer;transition:opacity 120ms ease;letter-spacing:-0.005em;"
    ...
    @else
        ...
        <div style="text-align:center;padding:40px 20px;">
            ...
            <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;">
                <div style="background:#F5F5F4;border:1px solid #D6D3D1;padding:6px 12px;font-family:ui-monospace,'SF Mono',Menlo,monospace;font-size:11px;color:#292524;letter-spacing:.04em;">
