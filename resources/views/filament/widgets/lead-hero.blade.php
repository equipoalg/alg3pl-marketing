...
<div style="text-align:center;padding:32px 0;">
    ...
    <a href="/admin/leads/create" style="display:inline-flex;align-items:center;gap:6px;padding:7px 14px;background:#0C0A09;color:#FAFAF9;font-size:12px;font-weight:500;text-decoration:none;letter-spacing:-0.005em;">
