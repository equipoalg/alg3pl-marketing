...
<div style="display:flex;align-items:flex-start;justify-content:space-between;gap:32px;">
    <div>
        ...
        <div style="display:flex;align-items:baseline;gap:14px;">
            <span data-count-to="{{ $count }}" style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:44px;font-weight:400;color:var(--alg-ink);line-height:1;letter-spacing:-0.03em;font-variant-numeric:tabular-nums;">0</span>
    ...
    <div style="flex:1;min-width:0;display:flex;flex-direction:column;justify-content:flex-end;height:60px;">
        ...
        <svg viewBox="0 0 {{ $svgW }} {{ $svgH }}" style="width:100%;height:40px;opacity:0.5;" preserveAspectRatio="none">
            <polyline class="alg-sparkline-animate" points="{{ $pts }}" fill="none" stroke="var(--alg-ink)" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    ...
    <div style="text-align:right;">
        ...
        <p style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:44px;font-weight:400;color:var(--alg-ink);line-height:1;margin:0;letter-spacing:-0.03em;font-variant-numeric:tabular-nums;"><span data-count-to="{{ $conversionRate }}" data-count-decimals="1">0</span><span style="color:var(--alg-ink-3);font-size:22px;">%</span></p>
