...
{{-- HERO --}}
<section style="padding:28px 32px 24px;background:#FFFFFF;border:1px solid #E7E5E4;border-radius:8px;margin-bottom:16px;">
    <div style="display:flex;align-items:flex-start;justify-content:space-between;gap:24px;margin-bottom:24px;flex-wrap:wrap;">
        <div style="flex:1;min-width:280px;">
            ...
            <h1 style="margin:0;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:32px;font-weight:500;letter-spacing:-0.03em;color:#0C0A09;line-height:1.1;max-width:720px;">
                @if($totalLeads > 0)
    ...
    <div style="display:grid;grid-template-columns:auto auto auto auto 1fr;gap:0;align-items:stretch;">
        ...
        <a href="{{ $kpiLinksB[$kpi['id']] ?? '/admin' }}" style="padding:0 28px;{{ $i > 0 ? 'border-left:1px solid #E7E5E4;' : '' }}display:flex;flex-direction:column;justify-content:flex-end;gap:4px;text-decoration:none;color:inherit;transition:background 150ms ease-out;" onmouseover="this.style.background='#FAFAF9'" onmouseout="this.style.background='transparent'">
            ...
            <span style="font-family:'Geist Mono',ui-monospace,monospace;font-size:30px;font-weight:500;letter-spacing:-0.025em;color:#0C0A09;line-height:1;font-variant-numeric:tabular-nums;">{{ is_numeric($kpi['value']) ? number_format($kpi['value']) : $kpi['value'] }}</span>
            @if($kpi['delta'] != 0)
        ...
        <div style="padding:0 0 0 28px;display:flex;flex-direction:column;justify-content:flex-end;min-width:0;">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:6px;">
                <span style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:10.5px;color:#78716C;text-transform:uppercase;letter-spacing:0.08em;font-weight:500;">Tráfico · {{ count($trafficSeries['labels']) }} días</span>
                <span style="font-family:'Geist Mono',ui-monospace,monospace;font-size:11px;color:#78716C;">{{ number_format($totalTrafficB) }} sesiones</span>
            </div>
...
<section style="padding:22px 24px;background:#FFFFFF;border:1px solid #E7E5E4;border-radius:8px;margin-bottom:16px;">
    <div style="display:flex;align-items:baseline;justify-content:space-between;margin-bottom:14px;">
        <div>
            ...
            <p style="margin:4px 0 0;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#78716C;">{{ number_format($totalActiveB) }} leads en movimiento · valor estimado ${{ number_format($estimated) }} USD</p>
        </div>
    ...
    <div style="display:grid;grid-template-columns:repeat({{ count($pipelineData) }}, 1fr);gap:8px;">
        ...
        <a href="/admin/leads?tableFilters[status][value]={{ $stage['id'] }}" style="padding:14px 16px;border:1px solid #E7E5E4;border-radius:6px;background:#FFFFFF;border-top:2px solid {{ $stage['color'] }};display:flex;flex-direction:column;gap:6px;text-decoration:none;color:inherit;transition:all 150ms ease-out;" onmouseover="this.style.background='#FAFAF9';this.style.borderColor='#D6D3D1';this.style.borderTopColor='{{ $stage['color'] }}';" onmouseout="this.style.background='#FFFFFF';this.style.borderColor='#E7E5E4';this.style.borderTopColor='{{ $stage['color'] }}';">
            ...
            <div style="font-family:'Geist Mono',ui-monospace,monospace;font-size:22px;font-weight:500;letter-spacing:-0.02em;color:#0C0A09;font-variant-numeric:tabular-nums;">{{ $stage['count'] }}</div>
        </a>
        @endforeach
    </div>
</section>
        ...
        <div>
            <div style="display:flex;align-items:baseline;justify-content:space-between;margin-bottom:14px;">
                <div>
                    ...
                    <p style="margin:4px 0 0;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#78716C;">Top keywords · Search Console · período actual</p>
                </div>
                <a href="/admin/search-console-data" style="display:inline-flex;align-items:center;gap:4px;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#57534E;text-decoration:none;">
                    Abrir reporte
                    <svg width="11" height="11" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6 14L14 6M7 6h7v7"/></svg>
                </a>
            </div>
            <div>
                <div style="display:grid;grid-template-columns:1fr 60px 70px 80px;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:10.5px;color:#A8A29E;text-transform:uppercase;letter-spacing:0.06em;padding:8px 0;border-top:1px solid #292524;border-bottom:1px solid #E7E5E4;">
                    <div>Keyword</div>
                ...
                <div style="display:grid;grid-template-columns:1fr 60px 70px 80px;padding:11px 0;{{ $i < $keywords->count() - 1 ? 'border-bottom:1px solid #E7E5E4;' : '' }}font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:13px;align-items:center;">
                    <div style="color:#0C0A09;font-weight:500;">{{ $k->kw }}</div>
                ...
                @empty
                <div style="padding:32px 0;text-align:center;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#78716C;">Sin datos de Search Console aún.</div>
                @endforelse
            </div>
        </div>
        ...
        <div>
            <div style="display:flex;align-items:baseline;justify-content:space-between;margin-bottom:14px;">
                <div>
                    ...
                    <p style="margin:4px 0 0;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#78716C;">Distribución · período actual</p>
                </div>
            </div>
            <div style="display:flex;flex-direction:column;gap:10px;">
                ...
                <div style="display:grid;grid-template-columns:84px 1fr 56px;align-items:center;gap:10px;">
                    ...
                    <div style="position:relative;height:8px;background:#F5F5F4;border-radius:2px;">
                        <div style="position:absolute;inset:0;width:{{ $pct }}%;background:#0C0A09;border-radius:2px;"></div>
                    </div>
            ...
            <div style="margin-top:24px;padding-top:18px;border-top:1px solid #E7E5E4;">
                ...
                <p style="margin:3px 0 12px;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:11.5px;color:#78716C;">Leads — top 6 mercados</p>
                ...
                <div style="display:flex;align-items:flex-end;gap:12px;height:140px;padding:0 4px;">
                    ...
                    @php
                        ...
                        $color = $i < 2 ? '#1E3A8A' : '#292524';
                        $opacity = $i < 2 ? '1' : (0.45 - ($i * 0.04));
                    @endphp
                    <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:6px;">
                        <div style="font-family:'Geist Mono',ui-monospace,monospace;font-size:11px;color:#78716C;font-variant-numeric:tabular-nums;">{{ $cb->c }}</div>
                        <div style="width:100%;max-width:36px;height:{{ $h }}px;background:{{ $color }};opacity:{{ $opacity }};border-radius:2px 2px 0 0;"></div>
                        <div style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:11px;color:#78716C;">{{ strtoupper($cb->country?->code ?? '?') }}</div>
                    </div>
                    @endforeach
                </div>
                @else
                <div style="padding:32px 0;text-align:center;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:11px;color:#78716C;">Sin datos por país.</div>
                @endif
            </div>
        </div>
    </div>
        ...
        <div>
            <div style="display:flex;align-items:baseline;justify-content:space-between;margin-bottom:14px;">
                <div>
                    ...
                    <p style="margin:4px 0 0;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#78716C;">{{ $recentLeads->count() }} más recientes</p>
                </div>
            ...
            <div style="border-top:1px solid #292524;">
                ...
                @endphp
                <a href="/admin/leads/{{ $lead->id }}/edit" style="display:grid;grid-template-columns:1fr auto auto;gap:14px;padding:13px 8px;border-bottom:1px solid #E7E5E4;align-items:center;text-decoration:none;color:inherit;margin:0 -8px;border-radius:4px;transition:background 150ms ease-out;" onmouseover="this.style.background='#FAFAF9'" onmouseout="this.style.background='transparent'">
                    <div style="min-width:0;">
                        ...
                        <div style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:11.5px;color:#78716C;margin-top:2px;">{{ $lead->company ?: '—' }}@if($lead->country) · {{ strtoupper($lead->country->code ?? '') }}@endif · {{ $lead->created_at?->diffForHumans() }}</div>
                    </div>
                    ...
                    <div style="font-family:'Geist Mono',ui-monospace,monospace;font-size:13px;font-weight:500;color:#0C0A09;text-align:right;min-width:64px;font-variant-numeric:tabular-nums;">@if($lead->estimated_value)${{ number_format($lead->estimated_value) }}@else—@endif</div>
                </a>
                @empty
        ...
        <div>
            <div style="display:flex;align-items:baseline;justify-content:space-between;margin-bottom:14px;">
                <div>
                    ...
                    <p style="margin:4px 0 0;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#78716C;">{{ $campaigns->count() }} campañas · ${{ number_format($campaigns->sum(fn($c) => (float) ($c->budget ?? 0))) }} presupuesto</p>
                </div>
                <a href="/admin/campaigns/create" style="display:inline-flex;align-items:center;gap:4px;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#57534E;text-decoration:none;">
                    Crear
            ...
            <div style="border-top:1px solid #292524;">
                ...
                @php
                    $statusColors = ['active' => '#166534', 'paused' => '#78716C', 'scheduled' => '#1E3A8A', 'draft' => '#A8A29E'];
                ...
                @endphp
                <a href="/admin/campaigns/{{ $c->id }}/edit" style="padding:13px 8px;border-bottom:1px solid #E7E5E4;display:grid;grid-template-columns:1fr auto;gap:14px;align-items:center;text-decoration:none;color:inherit;margin:0 -8px;border-radius:4px;transition:background 150ms ease-out;" onmouseover="this.style.background='#FAFAF9'" onmouseout="this.style.background='transparent'">
                    <div style="min-width:0;">
                        <div style="display:flex;align-items:center;gap:8px;">
                            <span style="width:6px;height:6px;border-radius:50%;background:{{ $statusColor }};"></span>
                            <span style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:13px;font-weight:500;color:#0C0A09;">{{ $c->name }}</span>
                        </div>
                        <div style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:11.5px;color:#78716C;margin-top:4px;display:flex;gap:14px;flex-wrap:wrap;">
                            <span>{{ number_format($sent) }} envíos</span>
                            @if($openRate !== null)<span>Open <span style="font-family:'Geist Mono',ui-monospace,monospace;color:#292524;font-variant-numeric:tabular-nums;">{{ $openRate }}%</span></span>@endif
                            @if($ctr !== null)<span>CTR <span style="font-family:'Geist Mono',ui-monospace,monospace;color:#292524;font-variant-numeric:tabular-nums;">{{ $ctr }}%</span></span>@endif
                        </div>
                    </div>
                ...
                @empty
                <div style="padding:28px 0;text-align:center;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:13px;color:#78716C;">Sin campañas</div>
                @endforelse
            </div>
        </div>
    </div>
...
{{-- ACTIVITY + TASKS --}}
<section style="padding:22px 24px 28px;background:#FFFFFF;border:1px solid #E7E5E4;border-radius:8px;margin-bottom:16px;">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:32px;">
        ...
        <div>
            ...
            <div style="border-top:1px solid #292524;">
                ...
                <div style="display:grid;grid-template-columns:1fr auto;gap:14px;padding:11px 0;border-bottom:1px solid #E7E5E4;">
                    <div style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12.5px;color:#292524;line-height:1.5;">
                ...
                @empty
                <div style="padding:28px 0;text-align:center;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#78716C;">Sin actividad reciente.</div>
                @endforelse
            </div>
        </div>
        ...
        <div>
            ...
            <div style="border-top:1px solid #292524;">
                ...
                @php
                    ...
                    $prCol = $priority === 'alta' ? ['#FEF2F2', '#9F1239'] : ($priority === 'media' ? ['#FEF3C7', '#92400E'] : ['#F5F5F4', '#78716C']);
                @endphp
                <div style="display:grid;grid-template-columns:16px 1fr auto;gap:12px;padding:11px 0;align-items:center;border-bottom:1px solid #E7E5E4;">
                    <span style="width:14px;height:14px;border-radius:3px;border:1.5px solid #A8A29E;"></span>
                    <div style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:13px;color:#0C0A09;">
                        {{ $t->next_action }}
                    ...
                    <div style="display:flex;align-items:center;gap:8px;">
                        ...
                        @if($due)<span style="font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:11.5px;color:#78716C;">{{ $due->diffForHumans() }}</span>@endif
                    </div>
                </div>
                @empty
                <div style="padding:28px 0;text-align:center;font-family:'Geist',ui-sans-serif,system-ui,sans-serif;font-size:12px;color:#78716C;">Sin tareas pendientes.</div>
                @endforelse
            </div>
        </div>
    </div>
